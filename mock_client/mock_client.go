...
// SendTransactionSync mocks base method.
func (m *MockClient) SendTransactionSync(tx *pb.Transaction, opts *rpcx.TransactOpts) (*pb.Receipt, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendTransactionSync", tx, opts)
	ret0, _ := ret[0].(*pb.Receipt)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SendTransactionSync indicates an expected call of SendTransactionSync.
func (mr *MockClientMockRecorder) SendTransactionSync(tx, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendTransactionSync", reflect.TypeOf((*MockClient)(nil).SendTransactionSync), tx, opts)
}
